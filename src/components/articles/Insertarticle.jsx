...
const Insertarticle = () => {
    ...
    const getscategories=async()=>{
            try {
            const res=await axios.get("https://ecommerce-mern-eosin.vercel.app/api/scategorie")
            ...
            const handelesubmit = async (e) => {
                ...
                await axios.post("https://ecommerce-mern-eosin.vercel.app/api/article", article)
                navigate("/articles");
  ...
  return (
      <div className="container">
        ...
        <Form className="border p-3" onSubmit={handelesubmit} >
        <Row className="mb-2">
